/*  impl.c.vmso
 *
 *                     VIRTUAL MEMORY MAPPING FOR SOLARIS
 *
 *  $HopeName: MMsrc!vmso.c(MMdevel_protoposm_1.1) $
 *
...
#error "vmso.c is SunOS 4/SOLARIS specific, but neither OS_SUNOS not OS_SOLARIS is not set"
#endif
