 ...
 *   HopeName: MMsrc!eventgen.pl(MMdevel_gavinm_160033.2) $
 */
...
#define EVENT_0(type) \
  EVENT_BEGIN(type) \
  EVENT_END(type, 0, sizeof(EventStruct))
