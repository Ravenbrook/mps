 ...
 *
 * $HopeName: MMsrc!protan.c(MMdevel_assertid.2) $
...
SRCID(protan, "$HopeName: MMsrc!protan.c(MMdevel_assertid.2) $");
...
void ProtTramp(void **rReturn,
                ...
                void *p, size_t s)
{
  AVER(0xB6A40002, rReturn != NULL);
  AVER(0xB6A40003, FUNCHECK(f));
