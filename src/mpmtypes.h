 ...
 *
 * $HopeName: MMsrc!mpmtypes.h(MMdevel_shieldclass.1) $
...
typedef struct ShieldStruct *Shield;    /* impl.c.shield */
typedef struct ShieldClassStruct *ShieldClass; /* impl.c.shield */
...
typedef void (*ShieldProtectMethod)(Shield shield, AccessSet mode);
