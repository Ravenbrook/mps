 ...
 * 
 * $HopeName: MMsrc!poolmrg.c(MMdevel_control.1) $
...
SRCID(poolmrg, "$HopeName: MMsrc!poolmrg.c(MMdevel_control.1) $");
...
static PoolClassStruct PoolClassMRGStruct = {
  ...
  PoolTrivSizeMin,                      /* sizeMin */
  PoolTrivSizeCurrent,                  /* sizeCurrent */
