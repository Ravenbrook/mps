...
#define METER_INIT(meter, init) IGNORE(meter); IGNORE(init)
#define METER_ACC(meter, delta) IGNORE(meter); IGNORE(delta)
#define METER_WRITE(meter, stream) IGNORE(meter); IGNORE(stream)
