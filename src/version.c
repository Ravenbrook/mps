 ...
 *
 * $HopeName: MMsrc!version.c(MM_epcore_brisling.14) $
 ...
 * or whatever. */
#define MPS_RELEASE "release.epcore.brisling.6+ [$HopeName: MMsrc!version.c(MM_epcore_brisling.14) $] *** DEVELOPMENT ONLY ***"
