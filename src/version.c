 ...
 *
 * $HopeName: MMsrc!version.c(MM_epcore_brisling.12) $
 ...
 * or whatever. */
#define MPS_RELEASE "release.epcore.brisling.4+ [$HopeName: MMsrc!version.c(MM_epcore_brisling.12) $] *** DEVELOPMENT ONLY ***"
