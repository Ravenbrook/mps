...
/* ArenaClassStruct -- new generic arena class interface */
...
typedef struct ArenaStruct {
  ...
  RingStruct globalRing;	/* link in global list of arenas */
  ...
  RefSet history[ARENA_LD_LENGTH]; /* history of object movements */
} ArenaStruct;
