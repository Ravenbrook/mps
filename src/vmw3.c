 ...
 *
 * $HopeName: MMsrc!vmw3.c(MM_dylan_crow.1) $
...
SRCID(vmw3, "$HopeName: MMsrc!vmw3.c(MM_dylan_crow.1) $");
...
static Res VMSetCollectionStrategy(VM vm)
{
  ...
  /* Source: request.dylan.160112.sol.reset */
  if (ResOK == res) {
    if (vmRAMSize >= 110*1024*1024) {
      ...
      AMCRampGenFrequency = 960;
      AMCGen2RampmodeFrequency = 3840;
