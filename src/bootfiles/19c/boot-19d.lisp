;;;;
;;;; Boot file for changing the fasl file version numbers to 19d.
;;;;
...
;;;
(setf (symbol-value 'byte-fasl-file-version)       #x19d)
(setf (backend-fasl-file-version *target-backend*) #x19d)
